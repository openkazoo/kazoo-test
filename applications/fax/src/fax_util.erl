...
-spec collect_channel_props(
    kz_json:object(), kz_term:proplist() | kz_term:ne_binaries(), kz_term:proplist()
) ->
    kz_term:proplist().
...
-spec notify_email_list(kz_term:api_binary(), kz_term:api_binary(), kz_term:ne_binary() | list()) ->
    list().
