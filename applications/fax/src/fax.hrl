...
-define(SERIALIZE_OUTBOUND_NUMBER,
    kapps_config:get_is_true(?CONFIG_CAT, <<"serialize_outbound_numbers">>, 'true')
).
...
-define(SMTP_MSG_MAX_SIZE,
    kapps_config:get_integer(?CONFIG_CAT, <<"smtp_max_msg_size">>, 10485670)
).
