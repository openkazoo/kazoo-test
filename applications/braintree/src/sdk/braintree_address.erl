...
url(CustomerId, AddressId) ->
    lists:append([
        "/customers/", kz_term:to_list(CustomerId), "/addresses/", kz_term:to_list(AddressId)
    ]).
...
-spec find(kz_term:ne_binary() | nonempty_string(), kz_term:ne_binary() | nonempty_string()) ->
    bt_address().
...
-spec delete(kz_term:ne_binary() | nonempty_string(), kz_term:ne_binary() | nonempty_string()) ->
    bt_address().
...
record_to_xml(Address, ToString) ->
    ...
    Props1 =
        case Address#bt_address.update_existing of
