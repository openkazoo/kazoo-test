...
-spec build_im_endpoint(kz_json:object(), kz_json:object(), kapps_im:im()) ->
    {'ok', kz_json:objects()} | {'error', build_error()}.
...
-spec should_create_endpoint(kz_json:object(), kz_json:object(), kapps_im:im()) ->
...
-spec evaluate_rules_for_creation(kz_json:object(), kz_json:object(), kapps_im:im()) ->
    create_ep_acc().
...
-spec maybe_endpoint_disabled(kz_json:object(), kz_json:object(), kapps_im:im()) ->
    'ok' | {'error', 'endpoint_disabled'}.
...
-spec maybe_do_not_disturb(kz_json:object(), kz_json:object(), kapps_im:im()) ->
    'ok' | {'error', 'do_not_disturb'}.
...
-spec create_im_endpoints(kz_term:ne_binary(), kz_json:object(), kz_json:object(), kapps_im:im()) ->
    kz_json:objects().
