...
-record(directory_user, {
    first_name :: kz_term:ne_binary(),
    last_name :: kz_term:ne_binary(),
    full_name :: kz_term:ne_binary(),
    % DTMF-version of first, last
    first_last_keys :: kz_term:ne_binary(),
    % DTMF-version of last, first
    last_first_keys :: kz_term:ne_binary(),
    % what callflow to use on match
    callflow_id :: kz_term:ne_binary(),
    % pre-recorded audio of user's name
    name_audio_id :: kz_term:api_binary()
}).
