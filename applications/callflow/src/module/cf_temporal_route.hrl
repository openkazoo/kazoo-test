...
-type strict_ordinal() :: binary().
%%<<"every">> | <<"last">>.
-type broad_ordinal() :: binary().
...
-type cycle_type() :: binary().

-record(keys, {
    enable = <<"1">> :: kz_term:ne_binary(),
...
-record(prompts, {
    marked_disabled = <<"temporal-marked_disabled">> :: kz_term:ne_binary(),
