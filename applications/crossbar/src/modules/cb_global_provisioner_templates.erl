...
init() ->
    ...
    _ = crossbar_bindings:bind(
        <<"*.content_types_provided.global_provisioner_templates">>,
        ?MODULE,
        'content_types_provided'
    ),
    _ = crossbar_bindings:bind(
        <<"*.content_types_accepted.global_provisioner_templates">>,
        ?MODULE,
        'content_types_accepted'
    ),
    _ = crossbar_bindings:bind(
        <<"*.allowed_methods.global_provisioner_templates">>, ?MODULE, 'allowed_methods'
    ),
    _ = crossbar_bindings:bind(
        <<"*.resource_exists.global_provisioner_templates">>, ?MODULE, 'resource_exists'
    ),
    ...
    _ = crossbar_bindings:bind(
        <<"*.execute.delete.global_provisioner_templates">>, ?MODULE, 'delete'
    ),
    'ok'.
...
post(Context, DocId) ->
    ...
    case cb_context:resp_status(Context1) of
        'success' ->
            ...
            Context2 = crossbar_doc:save_attachment(
...
load_provisioner_template(DocId, Context) ->
    ...
    case cb_context:resp_status(Context1) of
        'success' ->
            Context2 = crossbar_doc:load_attachment(
