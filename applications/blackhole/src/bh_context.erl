...
-export([
    ...
    remove_bindings/2,
    is_bound/2,
    websocket_session_id/1,
    set_websocket_session_id/2,
    websocket_pid/1,
    set_websocket_pid/2,
    timestamp/1,
    set_timestamp/2,
...
-export([
    match_auth_account_id/1, match_auth_account_id/2,
...
-record(bh_context, {
    auth_token = <<>> :: kz_term:api_binary() | '_',
...
from_json(Context, JObj) ->
    ...
    Setters = [
        {fun set_auth_token/2, kz_json:get_ne_binary_value(<<"auth_token">>, JObj)},
