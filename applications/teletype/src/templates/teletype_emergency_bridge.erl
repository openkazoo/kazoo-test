...
-define(TEMPLATE_MACROS,
    kz_json:from_list(
        [
            ...
            ?MACRO_VALUE(
                <<"call.emergency_caller_id_name">>,
                <<"emergency_caller_id_name">>,
                <<"Emergency Caller ID Name">>,
                <<"Emergency Caller ID Name">>
            ),
            ?MACRO_VALUE(
                <<"call.emergency_caller_id_number">>,
            ...
            ?MACRO_VALUE(
                <<"call.device_name">>, <<"device_name">>, <<"Device Name">>, <<"Device Name">>
            ),
            ?MACRO_VALUE(
                <<"call.emergency_address_street_1">>,
                <<"emergency_address_street_1">>,
                <<"Emergency Address Street 1">>,
                <<"Emergency Address Street 1">>
            ),
            ?MACRO_VALUE(
                <<"call.emergency_address_street_2">>,
                <<"emergency_address_street_2">>,
            ...
            ?MACRO_VALUE(
                <<"call.emergency_notification_contact_emails">>,
                <<"emergency_notification_contact_emails">>,
                <<"Emergency Contact Emails">>,
                <<"Emergency Contact Emails">>
            ),
            ?MACRO_VALUE(
                <<"call.emergency_test_call">>,
                <<"emergency_test_call">>,
                <<"Emergency Test Call">>,
                <<"Emergency Test Call">>
            ),
            ?MACRO_VALUE(
                <<"call.emergency_to_did">>,
                <<"emergency_to_did">>,
                <<"Emergency To DID">>,
                <<"Emergency To DID">>
            ),
            ...
            ?MACRO_VALUE(
                <<"call.user_email">>, <<"user_email">>, <<"User Email">>, <<"User Email">>
            ),
            ?MACRO_VALUE(
...
-define(TEMPLATE_SUBJECT,
    <<"Emergency{%if call.emergency_test_call %} Test{% endif %} Call Notification from Account '{{account.name}}'">>
).
