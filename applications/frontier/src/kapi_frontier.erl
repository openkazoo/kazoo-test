...
-define(RATELIMITS_REQ_VALUES, [
    {<<"Event-Category">>, <<"rate_limit">>},
    {<<"Event-Name">>, <<"query">>}
]).
-define(RATELIMITS_RESP_VALUES, [
    {<<"Event-Category">>, <<"rate_limit">>},
    {<<"Event-Name">>, <<"query_resp">>}
]).
-define(RATELIMITS_RESP_TYPES, [
    {<<"Realm">>, fun kz_json:is_json_object/1},
    {<<"Device">>, fun kz_json:is_json_object/1}
]).

-define(ACL_REQ_VALUES, [
    {<<"Event-Category">>, <<"acl">>},
    {<<"Event-Name">>, <<"query">>}
]).
-define(ACL_RESP_VALUES, [
    {<<"Event-Category">>, <<"acl">>},
    {<<"Event-Name">>, <<"query_resp">>}
]).
-define(ACL_RESP_TYPES, [
    {<<"Realm">>, fun kz_json:is_json_object/1},
    {<<"Device">>, fun kz_json:is_json_object/1}
]).
...
ratelimits_resp(JObj) ->
    ratelimits_resp(kz_json:to_proplist(JObj)).
...
publish_ratelimits_resp(Srv, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?RATELIMITS_RESP_VALUES, fun ratelimits_resp/1
    ),
...
ratelimits_req_v(JObj) ->
    ratelimits_req_v(kz_json:to_proplist(JObj)).
...
acls_resp(JObj) ->
    acls_resp(kz_json:to_proplist(JObj)).
...
acls_req_v(JObj) ->
    acls_req_v(kz_json:to_proplist(JObj)).
...
acls_resp_v(JObj) ->
    acls_resp_v(kz_json:to_proplist(JObj)).
