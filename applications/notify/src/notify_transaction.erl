...
handle_req(JObj, _Props) ->
    ...
    CustomSubjectTemplate = kz_json:get_value(
        [<<"notifications">>, <<"transaction">>, <<"email_subject_template">>], Account
    ),
...
create_template_props(Event, Account) ->
    props:filter_empty([
        ...
        {<<"plan">>,
            notify_util:json_to_template_props(kz_json:get_value(<<"Service-Plan">>, Event))},
        ...
        [
            ...
            {<<"address">>,
                props:filter_undefined(
                    [
                        {<<"first_name">>,
                            props:get_value([<<"billing_address">>, <<"first_name">>], Props)},
                        {<<"last_name">>,
                            props:get_value([<<"billing_address">>, <<"last_name">>], Props)},
                        {<<"company">>,
                            props:get_value([<<"billing_address">>, <<"company">>], Props)},
                        {<<"street_address">>,
                            props:get_value([<<"billing_address">>, <<"street_address">>], Props)},
                        {<<"extended_address">>,
                            props:get_value([<<"billing_address">>, <<"extended_address">>], Props)},
                        {<<"locality">>,
                            props:get_value([<<"billing_address">>, <<"locality">>], Props)},
                        {<<"region">>,
                            props:get_value([<<"billing_address">>, <<"region">>], Props)},
                        {<<"postal_code">>,
                            props:get_value([<<"billing_address">>, <<"postal_code">>], Props)},
                        {<<"country_name">>,
                            props:get_value([<<"billing_address">>, <<"country_name">>], Props)},
...
get_transaction_amount('undefined') ->
    'undefined';
...
purchase_order(Props) ->
    binary:replace(
        props:get_ne_binary_value(<<"purchase_order">>, Props, <<>>),
        <<"_">>,
        <<" ">>,
        [global]
    ).
