...
-spec register_backend(kz_term:ne_binary(), kz_term:ne_binary()) ->
...
-spec modify_backend(kz_term:ne_binary(), fun((kz_json:object()) -> kz_json:object())) ->
...
-spec maybe_modify_backend(
    kz_term:ne_binary(), fun((kz_json:object()) -> kz_json:object()), kz_json:object()
) -> kz_json:object().
