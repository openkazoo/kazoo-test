...
-define(BINDINGS, []).
-define(RESPONDERS, [{{'kz_hooks_util', 'handle_call_event'}, [{<<"call_event">>, <<"*">>}]}]).
-define(QUEUE_NAME, <<>>).
...
binding_to_call_event({_Binding, _BindProps}, CallEvents) ->
    CallEvents.
