...
-record(data_connection, {
    id = {kz_time:now_s(), kz_binary:rand_hex(4)},
    app :: atom() | '$1',
    props = #{} :: map() | '_',
    server :: any() | '$2',
...
-record(copy_doc, {
    source_dbname :: kz_term:ne_binary(),
