...
simple_successful_validation_test_() ->
    ChildData = kz_json:from_list([
        {<<"key1">>, <<"value1">>},
        {<<"key2">>, 1}
    ]),
    Child = kz_json:from_list([
        {<<"module">>, <<"test">>},
        {<<"data">>, ChildData}
    ]),
...
nested_children_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            <<"value3">>,
            kz_json:get_value([<<"children">>, <<"_">>, <<"data">>, <<"key3">>], ValidatedFlow)
        )
    ].
...
simple_failed_test_() ->
    ...
    [
        ?_assertMatch(
            [{'data_invalid', _SchemaJObj, 'wrong_type', 'true', [<<"data">>, <<"key1">>]}], Errors
        )
    ].
...
complex_failed_test_() ->
    ...
    [
        ?_assertMatch(
            [
                {'data_invalid', _Key2SchemaJObj, 'wrong_type', 'true', [<<"data">>, <<"key2">>]},
...
child_action_failure_test_() ->
    ...
    [
        ...
        ?_assertMatch(
            [
                {'data_invalid', _, 'missing_required_property', <<"module">>, [
                    <<"children">>, <<"ca1">>
                ]},
                {'data_invalid', _, 'missing_required_property', <<"key1">>, [<<"data">>]},
                {'data_invalid', _, 'missing_required_property', <<"key2">>, [<<"data">>]}
            ],
            Errors
        )
    ].
    ...
    [
        ...
        ?_assertMatch(
            [
                _,
                _,
                {'data_invalid', _SchemaJObj, 'missing_required_property', <<"key1">>, [<<"data">>]},
                _
            ],
            Errors
        )
