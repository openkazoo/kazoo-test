...
-type doc_validation_fun() :: fun(
    (kz_term:api_ne_binary(), doc_validation_acc()) -> doc_validation_acc()
).
-type doc_validation_after_fun() ::
    fun((doc_validation_acc()) -> doc_validation_acc()) | 'undefined'.
-type doc_validation_return() ::
    {'true', kz_doc:doc()}
    | {'validation_errors', doc_validation_errors()}
    | {'system_error', atom() | {atom(), kz_term:ne_binary()}}.
-export_type([
    doc_validation_error/0,
    doc_validation_errors/0,
    doc_validation_acc/0,
    doc_validation_fun/0,
