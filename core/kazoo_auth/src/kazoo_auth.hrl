...
-define(KAZOO_SIGNATURE_SECRET,
    kapps_config:get_ne_binary(?CONFIG_CAT, ?KAZOO_SIGNATURE_ID, ?KAZOO_GEN_SIGNATURE_SECRET)
).

-define(RSA_KEY_SIZE, 2048).

-define(SYSTEM_KEY_ID,
    kapps_config:get_ne_binary(?CONFIG_CAT, <<"system_key">>, kz_binary:rand_hex(16))
).
...
-define(JWT_MAP_CLAIMS, [
    {access_token, <<"auth_app_token">>},
