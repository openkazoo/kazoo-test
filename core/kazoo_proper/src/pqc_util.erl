...
transition_if_fold({_Fun, _Args}, {'false', _} = False) ->
    False;
...
run_counterexample(PQC) ->
    ...
    try run_counterexample(PQC, proper:counterexample(), InitialState) of
        ...
        'throw':{'failed_postcondition', PreCallState, {M, F, A}, Resp} ->
...
run_counterexample(_PQC, 'undefined', _State) ->
    {'error', 'no_counterexample'};
