...
seq_api() ->
    ...
    'true' =
        ([] =/= kz_json:is_json_object([<<"data">>, <<"call">>], kz_json:decode(AvailableBindings))),
...
recv_channel_event(WSConn, CallId, AccountId) ->
    ...
    AccountId = kz_json:get_ne_binary_value(
        [<<"data">>, <<"custom_channel_vars">>, <<"account_id">>], CallEvent
    ),
