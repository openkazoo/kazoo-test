...
-define(TMP_PATH,
    kapps_config:get_binary(?MOD_CONFIG_CAT, <<"temporary_storage_path">>, <<"/tmp">>)
).

-record(voice_desc, {
    voice_name :: kz_term:ne_binary(),
...
-type conversion_return() ::
    {binary(), kz_term:ne_binary()}
