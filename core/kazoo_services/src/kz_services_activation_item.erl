...
-record(activation_item, {
    category_name :: kz_term:ne_binary(),
...
create(_, Changes, _A) when
    Changes =< 0
->
    'undefined';
create(_, _, 'undefined') ->
    'undefined';
create(_, _, ActivationCharge) when
    ActivationCharge =< 0.0
->
    'undefined';
create(Item, Changes, ActivationCharge) ->
    Setters = [
        {fun set_category_name/2, kz_services_item:category_name(Item)},
