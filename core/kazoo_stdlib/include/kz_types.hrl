...
-define(WORKER(I),
    {I, {I, 'start_link', []}, 'permanent', 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_ARGS(I, Args),
    {I, {I, 'start_link', Args}, 'permanent', 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_TYPE(I, Type),
    {I, {I, 'start_link', []}, Type, 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_ARGS_TYPE(I, Args, Type),
    {I, {I, 'start_link', Args}, Type, 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_NAME_ARGS(I, N, Args),
    {N, {I, 'start_link', Args}, 'permanent', 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_NAME_ARGS_TYPE(N, I, Args, Type),
    {N, {I, 'start_link', Args}, Type, 5 * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
-define(WORKER_APP_INIT(I, T),
    {I, {I, 'start_link', []}, 'temporary', T * ?MILLISECONDS_IN_SECOND, 'worker', [I]}
).
...
-define(SUPER_ARGS(I, Args),
    {I, {I, 'start_link', Args}, 'permanent', 'infinity', 'supervisor', [I]}
).
-define(SUPER_ARGS_TYPE(I, Args, Type),
    {I, {I, 'start_link', Args}, Type, 'infinity', 'supervisor', [I]}
).
-define(SUPER_NAME_ARGS(I, N, Args),
    {N, {I, 'start_link', Args}, 'permanent', 'infinity', 'supervisor', [I]}
).
-define(SUPER_NAME_ARGS_TYPE(N, I, Args, Type),
    {N, {I, 'start_link', Args}, Type, 'infinity', 'supervisor', [I]}
).
-define(SUPER_NAME_TYPE(N, I, Type),
    {N, {I, 'start_link', []}, Type, 'infinity', 'supervisor', [I]}
).

-define(CACHE(N),
    {N, {'kz_cache_sup', 'start_link', [N]}, 'permanent', 'infinity', 'supervisor', [
        'kz_cache_sup'
    ]}
).
-define(CACHE_ARGS(N, Arg),
    {N, {'kz_cache_sup', 'start_link', [N, Arg]}, 'permanent', 'infinity', 'supervisor', [
        'kz_cache_sup'
    ]}
).
-define(CACHE_ARGS(N, Expires, Props),
    {N, {'kz_cache_sup', 'start_link', [N, Expires, Props]}, 'permanent', 'infinity', 'supervisor',
        ['kz_cache_sup']}
).
...
-define(MATCH_ACCOUNT_RAW(A, B, Rest),
    %% FIXME: add missing size (Rest:28)
...
-define(MATCH_MODB_SUFFIX_RAW(A, B, Rest, Year, Month),
    <<(A):2/binary, (B):2/binary, (Rest):28/binary, "-", (Year):4/binary, (Month):2/binary>>
).
...
-define(MATCH_RESOURCE_SELECTORS_RAW(A, B, Rest),
    <<(A):2/binary, (B):2/binary, (Rest):28/binary, "-selectors">>
).
-define(MATCH_RESOURCE_SELECTORS_UNENCODED(A, B, Rest),
    <<"account/", (A):2/binary, "/", (B):2/binary, "/", (Rest):28/binary, "-selectors">>
).
