...
-spec to_iso8601(calendar:date() | calendar:datetime() | kz_time:gregorian_seconds()) ->
    kz_term:ne_binary().
...
-spec to_iso8601_extended(calendar:date() | calendar:datetime() | kz_time:gregorian_seconds()) ->
    kz_term:ne_binary().
...
days_in_month(_Year, 1) ->
    31;
days_in_month(_Year, 3) ->
    31;
days_in_month(_Year, 5) ->
    31;
days_in_month(_Year, 7) ->
    31;
days_in_month(_Year, 8) ->
    31;
days_in_month(_Year, 10) ->
    31;
days_in_month(_Year, 12) ->
    31;
days_in_month(_Year, 4) ->
    30;
days_in_month(_Year, 6) ->
    30;
days_in_month(_Year, 9) ->
    30;
days_in_month(_Year, 11) ->
    30;
days_in_month(Year, 0) ->
    days_in_month(Year - 1, 12);
days_in_month(Year, 13) ->
    days_in_month(Year + 1, 1);
