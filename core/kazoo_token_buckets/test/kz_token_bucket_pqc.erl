...
precondition('ok', {'call', ?SERVER, 'start_link', _Args}) ->
    'true';
precondition('ok', _Call) ->
    'false';
precondition(_Method, _Call) ->
    'true'.
...
adjust_for_time(
    ...
    case Handled + Wait of
        ...
        N -> adjust_for_time(Model, N, wait_tokens(N, FR))
    end.
