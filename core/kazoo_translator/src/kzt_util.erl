...
-export([
    ...
    set_call_timeout/2,
    get_call_timeout/1,
    set_call_time_limit/2,
    get_call_time_limit/1,
    set_record_call/2,
    get_record_call/1,
    set_voice_uri/2,
    get_voice_uri/1,
    set_voice_uri_method/2,
    get_voice_uri_method/1,

    set_digits_collected/2,
    get_digits_collected/1,
    add_digit_collected/2,
    clear_digits_collected/1,

    set_recording_url/2,
    get_recording_url/1,
    set_recording_duration/2,
    get_recording_duration/1,
    set_recording_sid/2,
    get_recording_sid/1,

    set_transcription_sid/2,
    get_transcription_sid/1,
    set_transcription_text/2,
    get_transcription_text/1,
    set_transcription_status/2,
    get_transcription_status/1,
    set_transcription_url/2,
    get_transcription_url/1,

    set_dial_call_status/2,
    get_dial_call_status/1,
    set_dial_call_sid/2,
    get_dial_call_sid/1,
    set_dial_call_duration/2,
    get_dial_call_duration/1,
    set_queue_sid/2,
    get_queue_sid/1,
    set_dequeue_result/2,
    get_dequeue_result/1,
    set_dequeued_call_sid/2,
    get_dequeued_call_sid/1,
    set_dequeued_call_queue_time/2,
    get_dequeued_call_queue_time/1,
    set_dequeued_call_duration/2,
    get_dequeued_call_duration/1,
    set_media_meta/2,
    get_media_meta/1,
    set_amqp_listener/2,
    get_amqp_listener/1,
    ...
    set_conference_profile/2,
    get_conference_profile/1,
    set_caller_controls/2,
    get_caller_controls/1,
    set_advertise/2,
    get_advertise/1,
    set_chat_permissions/2,
    get_chat_permissions/1,
...
http_method(Method) ->
    http_method(kz_term:to_binary(Method)).
...
add_digit_collected(D, Call) ->
    kapps_call:kvs_update(
        <<"digits_collected">>,
        fun
            (<<_/binary>> = Ds) -> <<Ds/binary, D/binary>>;
            (_) -> D
        end,
        D,
        Call
...
set_dequeued_call_queue_time(DCS, Call) ->
    kapps_call:kvs_store(<<"dequeued_call_queue_time">>, DCS, Call).
...
set_dequeued_call_duration(DCS, Call) ->
    kapps_call:kvs_store(<<"dequeued_call_duration">>, DCS, Call).
