...
%% check every hour
-define(TIMEOUT, ?MILLISECONDS_IN_HOUR).
...
-record(kz_couch_connection, {
    id = kz_time:now_s() :: kz_time:gregorian_seconds(),
...
-record(kz_copy_doc, {
    source_dbname :: kz_term:api_ne_binary(),
