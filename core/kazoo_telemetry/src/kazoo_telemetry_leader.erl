...
-spec determine_kztm_oldest_node_fold({node(), kz_term:api_object()}, oldest_kztm_node()) ->
    oldest_kztm_node().
...
maybe_stop_responders(_State, 'false') ->
    'ok';
