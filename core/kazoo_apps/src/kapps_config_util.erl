...
-spec load_config_from_account(kz_term:api_binary(), kz_term:ne_binary()) ->
    {ok, kz_json:object()} | {error, any()}.
load_config_from_account(undefined, _Config) ->
    {ok, kz_json:new()};
...
-spec load_config_from_reseller(kz_term:api_binary(), kz_term:ne_binary()) ->
    {ok, kz_json:object()} | {error, any()}.
load_config_from_reseller(undefined, _Config) ->
    {error, not_found};
...
load_config_from_system(_Account, Config) ->
    {'ok',
        kz_json:get_value(
            <<"default">>, maybe_new(kapps_config:get_category(Config)), kz_json:new()
        )}.
...
-spec load_system_config_schema() ->
    {'ok', kz_json:object()}
    | {'error', 'not_found'}.
...
get_system_config_document_schema(Id) ->
    ...
    Values = [
        {[<<"properties">>, <<"default">>, <<"$ref">>], SchemaName}
