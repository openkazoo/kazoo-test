...
-define(MODULE_REQ_VALUES, [
    {<<"Event-Category">>, <<"websockets">>},
    {<<"Event-Name">>, <<"module_req">>},
    {<<"Action">>, [<<"start">>, <<"stop">>]}
]).
-define(MODULE_REQ_TYPES, [
...
-define(MODULE_RESP_VALUES, [
    {<<"Event-Category">>, <<"websockets">>},
    {<<"Event-Name">>, <<"module_resp">>}
]).
-define(MODULE_RESP_TYPES, [
...
-define(WEBSOCKETS_GET_REQ_VALUES, [
    {?KEY_EVENT_NAME, <<"get_req">>}
    | ?WEBSOCKETS_VALUES
]).
...
-define(WEBSOCKETS_GET_RESP_VALUES, [
    {?KEY_EVENT_NAME, <<"get_resp">>}
    | ?WEBSOCKETS_VALUES
]).
