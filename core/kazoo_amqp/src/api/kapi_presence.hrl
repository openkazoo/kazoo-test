...
-define(SEARCH_PARTIAL_RESP_VALUES, [
    {<<"Event-Category">>, <<"presence">>},
...
-define(OPTIONAL_UPDATE_HEADERS, [
    <<"To">>,
    <<"To-Tag">>,
    <<"From">>,
    <<"From-Tag">>,
...
%% MWI Update
-define(MWI_REQ_HEADERS, [
    <<"To">>,
    <<"Messages-New">>,
    <<"Messages-Saved">>
]).
-define(OPTIONAL_MWI_REQ_HEADERS, [
    <<"Messages-Urgent">>,
...
-define(MWI_REQ_VALUES, [
    {<<"Event-Category">>, <<"presence">>},
    {<<"Event-Name">>, <<"mwi_update">>}
]).
-define(MWI_UNSOLICITED_REQ_VALUES, [
    {<<"Event-Category">>, <<"presence">>},
    {<<"Event-Name">>, <<"mwi_unsolicited_update">>}
]).
-define(MWI_REQ_TYPES, [
...
%% Register_Overwrite
-define(REGISTER_OVERWRITE_HEADERS, [
    <<"Previous-Contact">>,
    <<"Contact">>,
    <<"Username">>,
    <<"Realm">>
...
-define(REGISTER_OVERWRITE_VALUES, [
    {<<"Event-Category">>, <<"presence">>},
...
-define(OPTIONAL_DIALOG_HEADERS, [
    <<"Call-ID">>,
    <<"Direction">>,
    <<"Event-Package">>,
    <<"State">>,
