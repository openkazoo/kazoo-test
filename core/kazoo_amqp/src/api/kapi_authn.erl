...
-define(AUTHN_REQ_VALUES, [
    {<<"Event-Category">>, ?EVENT_CATEGORY},
    {<<"Event-Name">>, ?AUTHN_REQ_EVENT_NAME}
]).
-define(AUTHN_REQ_TYPES, [
    {<<"To">>, fun is_binary/1},
...
-define(OPTIONAL_AUTHN_RESP_HEADERS, [
    <<"Custom-Channel-Vars">>,
    <<"Custom-SIP-Headers">>,
    <<"Auth-Username">>,
    <<"Auth-Nonce">>,
...
get_auth_user(ApiJObj) ->
    AuthUser =
        case kz_json:get_value(<<"Auth-User">>, ApiJObj, <<"unknown">>) of
            <<"unknown">> ->
...
get_auth_realm(ApiJObj) ->
    get_auth_realm(kz_json:to_proplist(ApiJObj)).
