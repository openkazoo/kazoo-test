...
-define(CHANNEL_STATUS_REQ_VALUES, [
...
-define(CHANNEL_STATUS_RESP_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
    {<<"Event-Name">>, <<"channel_status_resp">>},
    {<<"Status">>, [<<"active">>, <<"tmpdown">>, <<"terminated">>]}
]).
-define(CHANNEL_STATUS_RESP_TYPES, [
    {<<"Custom-Application-Vars">>, fun kz_json:is_json_object/1},
    {<<"Custom-Channel-Vars">>, fun kz_json:is_json_object/1}
]).
...
-define(QUERY_AUTH_ID_REQ_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(QUERY_AUTH_ID_RESP_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(QUERY_USER_CHANNELS_REQ_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(QUERY_USER_CHANNELS_RESP_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(OPTIONAL_QUERY_ACCOUNT_CHANNELS_REQ_HEADERS, [
    <<"Active-Only">>, <<"Username">>, <<"Usernames">>
]).
-define(QUERY_ACCOUNT_CHANNELS_REQ_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
    {<<"Event-Name">>, <<"query_account_channels_req">>}
]).
-define(QUERY_ACCOUNT_CHANNELS_REQ_TYPES, [
    {<<"Usernames">>, fun erlang:is_list/1},
    {<<"Username">>, fun erlang:is_binary/1},
    {<<"Active-Only">>, fun kz_term:is_boolean/1}
]).
...
-define(QUERY_ACCOUNT_CHANNELS_RESP_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(OPTIONAL_QUERY_CHANNELS_REQ_HEADERS, [
    <<"Fields">>,
    <<"Call-ID">>,
    <<"Active-Only">>
]).
-define(QUERY_CHANNELS_REQ_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(QUERY_CHANNELS_RESP_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(CALL_USURP_CONTROL_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
...
-define(PUBLISHER_USURP_CONTROL_VALUES, [
    {<<"Event-Category">>, <<"call_event">>},
