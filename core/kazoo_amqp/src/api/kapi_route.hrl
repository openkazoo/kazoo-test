...
%% Route Requests
-define(ROUTE_REQ_HEADERS, [
    <<"From">>,
    <<"Request">>,
    <<"To">>,
    ?KEY_CALL_ID
]).
-define(OPTIONAL_ROUTE_REQ_HEADERS, [
    <<"Body">>,
    <<"Call-Direction">>,
    <<"Caller-ID-Name">>,
    <<"Caller-ID-Number">>,
...
-define(ROUTE_REQ_COST_PARAMS, [
    <<"Max-Incremental-Cost">>,
    <<"Max-Setup-Cost">>,
    <<"Min-Increment-Cost">>,
    <<"Min-Setup-Cost">>
]).
-define(ROUTE_REQ_TYPES, [
...
-define(OPTIONAL_ROUTE_RESP_ROUTE_HEADERS, [
    <<"Auth-Password">>,
    <<"Auth-User">>,
    <<"Caller-ID-Name">>,
    <<"Caller-ID-Number">>,
...
-define(ROUTE_RESP_ROUTE_VALUES, [
    {<<"Media">>, [<<"process">>, <<"bypass">>, <<"auto">>]},
    {<<"Caller-ID-Type">>, [<<"from">>, <<"rpid">>, <<"pid">>]},
    ?INVITE_FORMAT_TUPLE
]).
-define(ROUTE_RESP_ROUTE_TYPES, [
    {<<"Codecs">>, fun erlang:is_list/1},
    {<<"Custom-Application-Vars">>, fun kz_json:is_json_object/1},
    {<<"Custom-Channel-Vars">>, fun kz_json:is_json_object/1},
    {<<"Custom-SIP-Headers">>, fun kz_json:is_json_object/1},
...
-define(ROUTE_WIN_VALUES, [
    {<<"Event-Category">>, ?EVENT_CATEGORY},
    {<<"Event-Name">>, <<"route_win">>}
]).
-define(ROUTE_WIN_TYPES, [
    {?KEY_CALL_ID, fun erlang:is_binary/1},
