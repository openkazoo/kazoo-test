...
-define(OPTIONAL_UNBRIDGE_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Leg">>
]).
-define(UNBRIDGE_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_PAGE_REQ_HEADERS, [
    <<"Caller-ID-Name">>,
    <<"Caller-ID-Number">>,
    <<"Callee-ID-Name">>,
    <<"Callee-ID-Number">>,
...
-define(PAGE_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"page">>},
    ?INSERT_AT_TUPLE
]).
-define(PAGE_REQ_TYPES, [
...
-define(OPTIONAL_STORE_REQ_HEADERS, [
    <<"Additional-Headers">>,
    <<"Suppress-Error-Report">>,
    <<"Insert-At">>
]).
-define(STORE_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(STORE_REQ_TYPES, [
    {<<"Additional-Headers">>, fun is_list/1},
    {<<"Suppress-Error-Report">>, fun kz_term:is_boolean/1}
]).

%% Store Fax
-define(STORE_FAX_HEADERS, [
    <<"Application-Name">>,
    <<"Call-ID">>,
    <<"Media-Transfer-Method">>,
    <<"Media-Transfer-Destination">>
]).
-define(OPTIONAL_STORE_FAX_HEADERS, [
    <<"Additional-Headers">>, <<"Insert-At">>, <<"Fax-Local-Filename">>
]).
-define(STORE_FAX_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(STORE_AMQP_RESP_HEADERS, [
    <<"Call-ID">>,
    <<"Application-Name">>,
    <<"Media-Transfer-Method">>,
    <<"Media-Name">>,
...
-define(TONES_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"tones">>},
    ?INSERT_AT_TUPLE
]).
-define(TONES_REQ_TYPES, [
    {<<"Tones">>, fun is_list/1},
...
%% Tone Detect
-define(TONE_DETECT_REQ_HEADERS, [
    <<"Call-ID">>,
    <<"Application-Name">>,
    <<"Tone-Detect-Name">>,
    <<"Frequencies">>
]).
-define(OPTIONAL_TONE_DETECT_REQ_HEADERS, [
    <<"Sniff-Direction">>,
    <<"Timeout">>,
    <<"On-Success">>,
    <<"Hits-Needed">>,
...
%% Audio level/mute
-define(AUDIO_REQ_HEADERS, [
    <<"Application-Name">>, <<"Insert-At">>, <<"Call-ID">>, <<"Action">>, <<"Level">>, <<"Mode">>
]).
-define(OPTIONAL_AUDIO_REQ_HEADERS, []).
-define(AUDIO_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_CALL_PICKUP_REQ_HEADERS, [
    ...
    <<"Continue-On-Fail">>,
    <<"Continue-On-Cancel">>,
    %% Will park either leg after cancel
    <<"Park-After-Pickup">>,
    <<"Hangup-After-Pickup">>,
    <<"Move-Channel-If-Necessary">>
]).
-define(CALL_PICKUP_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_CONNECT_LEG_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Unbridged-Only">>,
    <<"Unanswered-Only">>,
    <<"Other-Leg">>,
...
-define(CONNECT_LEG_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"connect_leg">>},
    ?INSERT_AT_TUPLE
]).
-define(CONNECT_LEG_REQ_TYPES, [
    {<<"Park-After-Pickup">>, fun kz_term:is_boolean/1},
    {<<"Hangup-After-Pickup">>, fun kz_term:is_boolean/1},
    {<<"Move-Channel-If-Necessary">>, fun kz_term:is_boolean/1},
...
-define(OPTIONAL_EAVESDROP_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Enable-DTMF">>,
    <<"Other-Leg">>,
    <<"Continue-On-Fail">>,
...
%% Play Request
-define(PLAY_REQ_HEADERS, [
    <<"Application-Name">>,
    <<"Call-ID">>,
    <<"Media-Name">>
]).
-define(OPTIONAL_PLAY_REQ_HEADERS, [
    <<"Endless-Playback">>,
    <<"Loop-Count">>,
    <<"Format">>,
    % group media together (one DTMF cancels all in group)
    <<"Group-ID">>,
    <<"Insert-At">>,
    <<"Language">>,
    <<"Leg">>,
...
%% PlaySeek Request
-define(PLAY_SEEK_REQ_HEADERS, [
    <<"Application-Name">>, <<"Call-ID">>, <<"Duration">>, <<"Direction">>
]).
-define(OPTIONAL_PLAY_SEEK_REQ_HEADERS, [<<"Insert-At">>]).
-define(PLAY_SEEK_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_RECORD_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Silence-Hits">>,
    <<"Silence-Threshold">>,
    <<"Terminators">>,
...
-define(RECORD_CALL_REQ_HEADERS, [
    <<"Application-Name">>,
    <<"Call-ID">>,
    <<"Record-Action">>
]).
-define(OPTIONAL_RECORD_CALL_REQ_HEADERS, [
    <<"Additional-Headers">>,
    <<"Channels-As-Stereo">>,
    <<"Follow-Transfer">>,
    <<"Insert-At">>,
...
-define(PLAY_COLLECT_DIGITS_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_TTS_REQ_HEADERS, [
    <<"Conference-ID">>,
    <<"Endless-Playback">>,
    <<"Loop-Count">>,
    <<"Engine">>,
...
-define(RESPOND_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"respond">>},
    ?INSERT_AT_TUPLE
]).
-define(RESPOND_REQ_TYPES, [
...
-define(REDIRECT_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"redirect">>},
    ?INSERT_AT_TUPLE
]).
-define(REDIRECT_REQ_TYPES, [
...
-define(OPTIONAL_EXECUTE_EXTENSION_REQ_HEADERS, [
    <<"Insert-At">>, <<"Reset">>, <<"Custom-Channel-Vars">>
]).
-define(EXECUTE_EXTENSION_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_NOOP_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Filter-Applications">>,
    <<"B-Leg-Events">>
]).
-define(NOOP_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
%% Conference
-define(CONFERENCE_REQ_HEADERS, [
    <<"Application-Name">>,
    <<"Call-ID">>,
    <<"Conference-ID">>
]).
-define(OPTIONAL_CONFERENCE_REQ_HEADERS, [
    <<"Insert-At">>,
    <<"Mute">>,
    <<"Deaf">>,
    <<"Moderator">>,
...
-define(CONFERENCE_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"conference">>},
    ?INSERT_AT_TUPLE
]).
-define(CONFERENCE_REQ_TYPES, [
...
-define(ORIGINATE_EXECUTE_VALUES, [
    {<<"Event-Category">>, <<"dialplan">>},
...
-define(OPTIONAL_FAX_DETECTION_REQ_HEADERS, [
    <<"Direction">>, <<"Action">>, <<"Duration">>, <<"Insert-At">>
]).
-define(FAX_DETECTION_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(OPTIONAL_STORE_VM_REQ_HEADERS, [
    <<"Additional-Headers">>,
    <<"Suppress-Error-Report">>,
    <<"Insert-At">>
]).
-define(STORE_VM_REQ_VALUES, [
    {<<"Event-Category">>, <<"call">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(STORE_VM_REQ_TYPES, [
    {<<"Additional-Headers">>, fun is_list/1},
    {<<"Suppress-Error-Report">>, fun kz_term:is_boolean/1}
]).

%% Transfer
-define(TRANSFER_HEADERS, [
    <<"Application-Name">>,
    <<"Call-ID">>,
    <<"Transfer-To">>,
    <<"Transfer-Type">>
]).
-define(OPTIONAL_TRANSFER_HEADERS, [
    <<"Insert-At">>,
    <<"Transfer-Leg">>,
    <<"Transfer-Context">>,
    <<"Caller-ID-Name">>,
...
%% soundtouch
-define(SOUNDTOUCH_HEADERS, [
    <<"Application-Name">>,
    <<"Insert-At">>,
    <<"Call-ID">>,
    <<"Action">>
]).
-define(OPTIONAL_SOUNDTOUCH_HEADERS, [
    <<"Sending-Leg">>,
    <<"Hook-DTMF">>,
    <<"Adjust-In-Semitones">>,
    <<"Adjust-In-Octaves">>,
