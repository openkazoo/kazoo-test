...
-export([
    publish_config_req/1, publish_config_req/2,
...
-define(OPTIONAL_DISCOVERY_REQ_HEADERS, [
    <<"Conference-Doc">>,
    <<"Conference-ID">>,
    <<"Conference-Name">>,
    <<"Moderator">>,
...
-define(ADD_PARTICIPANT_HEADERS, [
    <<"Call-ID">>,
    <<"Conference-ID">>,
    <<"Control-Queue">>
]).
...
%% Conference Deaf
-define(DEAF_PARTICIPANT_HEADERS, [
    <<"Application-Name">>, <<"Conference-ID">>, <<"Participant-ID">>
]).
-define(OPTIONAL_DEAF_PARTICIPANT_HEADERS, []).
-define(DEAF_PARTICIPANT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
%% Conference Energy
-define(PARTICIPANT_ENERGY_HEADERS, [
    <<"Application-Name">>,
    <<"Conference-ID">>,
    <<"Participant-ID">>,
    <<"Energy-Level">>
...
-define(PARTICIPANT_ENERGY_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(PARTICIPANTS_REQ_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(PARTICIPANTS_RESP_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
...
%% Conference Mute
-define(MUTE_PARTICIPANT_HEADERS, [
    <<"Application-Name">>, <<"Conference-ID">>, <<"Participant-ID">>
]).
-define(OPTIONAL_MUTE_PARTICIPANT_HEADERS, []).
-define(MUTE_PARTICIPANT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(RELATE_PARTICIPANTS_HEADERS, [
    <<"Application-Name">>,
    <<"Conference-ID">>,
    <<"Other-Participant">>,
    <<"Participant-ID">>
...
-define(RELATE_PARTICIPANTS_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"relate_participants">>},
    {<<"Relationship">>, [<<"deaf">>, <<"mute">>, <<"clear">>]}
]).
-define(RELATE_PARTICIPANTS_TYPES, [
    {<<"Conference-ID">>, fun is_binary/1},
    {<<"Participant-ID">>, fun(ID) ->
        is_integer(ID) orelse
            is_binary(ID)
    end},
    {<<"Other-Participant">>, fun(ID) ->
        is_integer(ID) orelse
            is_binary(ID)
    end}
]).
...
%% Conference Undeaf
-define(UNDEAF_PARTICIPANT_HEADERS, [
    <<"Application-Name">>, <<"Conference-ID">>, <<"Participant-ID">>
]).
-define(OPTIONAL_UNDEAF_PARTICIPANT_HEADERS, []).
-define(UNDEAF_PARTICIPANT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
%% Conference Unmute
-define(UNMUTE_PARTICIPANT_HEADERS, [
    <<"Application-Name">>, <<"Conference-ID">>, <<"Participant-ID">>
]).
-define(OPTIONAL_UNMUTE_PARTICIPANT_HEADERS, []).
-define(UNMUTE_PARTICIPANT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(PARTICIPANT_VOLUME_IN_HEADERS, [
    <<"Application-Name">>,
    <<"Conference-ID">>,
    <<"Participant-ID">>,
    <<"Volume-In-Level">>
...
-define(PARTICIPANT_VOLUME_IN_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(PARTICIPANT_VOLUME_OUT_HEADERS, [
    <<"Application-Name">>,
    <<"Conference-ID">>,
    <<"Participant-ID">>,
    <<"Volume-Out-Level">>
...
-define(PARTICIPANT_VOLUME_OUT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
...
-define(DIAL_TYPES, [
    ...
    {<<"Endpoints">>, fun(Es) ->
        kz_term:is_ne_list(Es) andalso
            kz_json:are_json_objects(Es)
    end},
...
-define(DIAL_RESP_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"command">>},
    {<<"Application-Name">>, <<"dial_resp">>}
]).
-define(DIAL_RESP_TYPES, [
    {<<"Endpoint-Responses">>, fun(Es) ->
        kz_term:is_ne_list(Es) andalso
            kz_json:are_json_objects(Es)
    end}
]).
...
-define(PARTICIPANT_EVENT_HEADERS, [
    <<"Event">>,
    <<"Call-ID">>,
    <<"Focus">>,
    <<"Conference-ID">>,
...
-define(PARTICIPANT_EVENT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
...
-define(CONFERENCE_EVENT_HEADERS, [
    <<"Event">>,
    <<"Conference-ID">>,
    <<"Instance-ID">>
]).
...
-define(CONFERENCE_EVENT_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"event">>}
]).
...
-define(CONFERENCE_ERROR_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"error">>}
]).
...
-define(CONFIG_RESP_VALUES, [
    {<<"Event-Category">>, <<"conference">>},
    {<<"Event-Name">>, <<"config_resp">>}
]).
-define(CONFIG_RESP_TYPES, []).

-define(APPLICTION_MAP, [
    {<<"deaf_participant">>, ?DEAF_PARTICIPANT_VALUES, fun deaf_participant/1},
...
-define(CONF_PLAY_MACRO_REQ_HEADERS, [
    <<"Application-Name">>,
    <<"Conference-ID">>,
    <<"Media-Macro">>
]).
...
tones_v(JObj) ->
    tones_v(kz_json:to_proplist(JObj)).
...
discovery_req(Prop) when is_list(Prop) ->
    case discovery_req_v(Prop) of
        'true' ->
            kz_api:build_message(Prop, ?DISCOVERY_REQ_HEADERS, ?OPTIONAL_DISCOVERY_REQ_HEADERS);
        'false' ->
            {'error', "Proplist failed validation for discovery"}
    end;
discovery_req(JObj) ->
    discovery_req(kz_json:to_proplist(JObj)).
...
discovery_req_v(JObj) ->
    discovery_req_v(kz_json:to_proplist(JObj)).
...
discovery_resp(Prop) when is_list(Prop) ->
    case discovery_resp_v(Prop) of
        'true' ->
            kz_api:build_message(Prop, ?DISCOVERY_RESP_HEADERS, ?OPTIONAL_DISCOVERY_RESP_HEADERS);
        'false' ->
            {'error', "Proplist failed validation for discovery resp"}
    end;
discovery_resp(JObj) ->
    discovery_resp(kz_json:to_proplist(JObj)).
...
discovery_resp_v(JObj) ->
    discovery_resp_v(kz_json:to_proplist(JObj)).
...
add_participant(Prop) when is_list(Prop) ->
    case add_participant_v(Prop) of
        'true' ->
            kz_api:build_message(Prop, ?ADD_PARTICIPANT_HEADERS, ?OPTIONAL_ADD_PARTICIPANT_HEADERS);
        'false' ->
            {'error', "Proplist failed validation for add participant"}
    end;
add_participant(JObj) ->
    add_participant(kz_json:to_proplist(JObj)).

-spec add_participant_v(kz_term:api_terms()) -> boolean().
add_participant_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?ADD_PARTICIPANT_HEADERS, ?ADD_PARTICIPANT_VALUES, ?ADD_PARTICIPANT_TYPES
    );
add_participant_v(JObj) ->
    add_participant_v(kz_json:to_proplist(JObj)).
    ...
    case deaf_participant_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?DEAF_PARTICIPANT_HEADERS, ?OPTIONAL_DEAF_PARTICIPANT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for deaf participant"}
    end;
deaf_participant(JObj) ->
    deaf_participant(kz_json:to_proplist(JObj)).

-spec deaf_participant_v(kz_term:api_terms()) -> boolean().
deaf_participant_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?DEAF_PARTICIPANT_HEADERS, ?DEAF_PARTICIPANT_VALUES, ?DEAF_PARTICIPANT_TYPES
    );
deaf_participant_v(JObj) ->
    deaf_participant_v(kz_json:to_proplist(JObj)).
...
participant_energy(Prop) when is_list(Prop) ->
    case participant_energy_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANT_ENERGY_HEADERS, ?OPTIONAL_PARTICIPANT_ENERGY_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for participant energy"}
    end;
participant_energy(JObj) ->
    participant_energy(kz_json:to_proplist(JObj)).

-spec participant_energy_v(kz_term:api_terms()) -> boolean().
participant_energy_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?PARTICIPANT_ENERGY_HEADERS, ?PARTICIPANT_ENERGY_VALUES, ?PARTICIPANT_ENERGY_TYPES
    );
participant_energy_v(JObj) ->
    participant_energy_v(kz_json:to_proplist(JObj)).
...
kick_v(JObj) ->
    kick_v(kz_json:to_proplist(JObj)).
...
participants_req(Prop) when is_list(Prop) ->
    case participants_req_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANTS_REQ_HEADERS, ?OPTIONAL_PARTICIPANTS_REQ_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for participants request"}
    end;
participants_req(JObj) ->
    participants_req(kz_json:to_proplist(JObj)).

-spec participants_req_v(kz_term:api_terms()) -> boolean().
participants_req_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?PARTICIPANTS_REQ_HEADERS, ?PARTICIPANTS_REQ_VALUES, ?PARTICIPANTS_REQ_TYPES
    );
participants_req_v(JObj) ->
    participants_req_v(kz_json:to_proplist(JObj)).
...
participants_resp(Prop) when is_list(Prop) ->
    case participants_resp_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANTS_RESP_HEADERS, ?OPTIONAL_PARTICIPANTS_RESP_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for participants response"}
    end;
participants_resp(JObj) ->
    participants_resp(kz_json:to_proplist(JObj)).

-spec participants_resp_v(kz_term:api_terms()) -> boolean().
participants_resp_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?PARTICIPANTS_RESP_HEADERS, ?PARTICIPANTS_RESP_VALUES, ?PARTICIPANTS_RESP_TYPES
    );
participants_resp_v(JObj) ->
    participants_resp_v(kz_json:to_proplist(JObj)).
...
lock_v(JObj) ->
    lock_v(kz_json:to_proplist(JObj)).
...
mute_participant(Prop) when is_list(Prop) ->
    case mute_participant_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?MUTE_PARTICIPANT_HEADERS, ?OPTIONAL_MUTE_PARTICIPANT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for mute participant"}
    end;
mute_participant(JObj) ->
    mute_participant(kz_json:to_proplist(JObj)).

-spec mute_participant_v(kz_term:api_terms()) -> boolean().
mute_participant_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?MUTE_PARTICIPANT_HEADERS, ?MUTE_PARTICIPANT_VALUES, ?MUTE_PARTICIPANT_TYPES
    );
...
play_v(JObj) ->
    play_v(kz_json:to_proplist(JObj)).
...
play_macro_req(Prop) when is_list(Prop) ->
    case play_macro_req_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?CONF_PLAY_MACRO_REQ_HEADERS, ?OPTIONAL_CONF_PLAY_MACRO_REQ_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for play_macro_req"}
    end;
play_macro_req(JObj) ->
    play_macro_req(kz_json:to_proplist(JObj)).

-spec play_macro_req_v(kz_term:api_terms()) -> boolean().
play_macro_req_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?CONF_PLAY_MACRO_REQ_HEADERS, ?CONF_PLAY_MACRO_REQ_VALUES, ?CONF_PLAY_MACRO_REQ_TYPES
    );
play_macro_req_v(JObj) ->
    play_macro_req_v(kz_json:to_proplist(JObj)).
...
record(JObj) ->
    record(kz_json:to_proplist(JObj)).
...
record_v(JObj) ->
    record_v(kz_json:to_proplist(JObj)).
...
recordstop(JObj) ->
    recordstop(kz_json:to_proplist(JObj)).
...
recordstop_v(JObj) ->
    recordstop_v(kz_json:to_proplist(JObj)).
...
relate_participants(Prop) when is_list(Prop) ->
    case relate_participants_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?RELATE_PARTICIPANTS_HEADERS, ?OPTIONAL_RELATE_PARTICIPANTS_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for relate participants"}
    end;
relate_participants(JObj) ->
    relate_participants(kz_json:to_proplist(JObj)).

-spec relate_participants_v(kz_term:api_terms()) -> boolean().
relate_participants_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?RELATE_PARTICIPANTS_HEADERS, ?RELATE_PARTICIPANTS_VALUES, ?RELATE_PARTICIPANTS_TYPES
    );
relate_participants_v(JObj) ->
    relate_participants_v(kz_json:to_proplist(JObj)).
...
stop_play(JObj) ->
    stop_play(kz_json:to_proplist(JObj)).
...
stop_play_v(JObj) ->
    stop_play_v(kz_json:to_proplist(JObj)).
...
undeaf_participant(Prop) when is_list(Prop) ->
    case undeaf_participant_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?UNDEAF_PARTICIPANT_HEADERS, ?OPTIONAL_UNDEAF_PARTICIPANT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for undeaf participant"}
    end;
undeaf_participant(JObj) ->
    undeaf_participant(kz_json:to_proplist(JObj)).

-spec undeaf_participant_v(kz_term:api_terms()) -> boolean().
undeaf_participant_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?UNDEAF_PARTICIPANT_HEADERS, ?UNDEAF_PARTICIPANT_VALUES, ?UNDEAF_PARTICIPANT_TYPES
    );
undeaf_participant_v(JObj) ->
    undeaf_participant_v(kz_json:to_proplist(JObj)).
...
unlock(JObj) ->
    unlock(kz_json:to_proplist(JObj)).
...
unlock_v(JObj) ->
    unlock_v(kz_json:to_proplist(JObj)).
...
unmute_participant(Prop) when is_list(Prop) ->
    case unmute_participant_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?UNMUTE_PARTICIPANT_HEADERS, ?OPTIONAL_UNMUTE_PARTICIPANT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for unmute participant"}
    end;
...
unmute_participant_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?UNMUTE_PARTICIPANT_HEADERS, ?UNMUTE_PARTICIPANT_VALUES, ?UNMUTE_PARTICIPANT_TYPES
    );
unmute_participant_v(JObj) ->
    unmute_participant_v(kz_json:to_proplist(JObj)).
...
participant_volume_in(Prop) when is_list(Prop) ->
    case participant_volume_in_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANT_VOLUME_IN_HEADERS, ?OPTIONAL_PARTICIPANT_VOLUME_IN_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for volume in"}
    end;
participant_volume_in(JObj) ->
    participant_volume_in(kz_json:to_proplist(JObj)).

-spec participant_volume_in_v(kz_term:api_terms()) -> boolean().
participant_volume_in_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop,
        ?PARTICIPANT_VOLUME_IN_HEADERS,
        ?PARTICIPANT_VOLUME_IN_VALUES,
        ?PARTICIPANT_VOLUME_IN_TYPES
    );
...
participant_volume_out(Prop) when is_list(Prop) ->
    case participant_volume_out_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANT_VOLUME_OUT_HEADERS, ?OPTIONAL_PARTICIPANT_VOLUME_OUT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for volume out"}
    end;
participant_volume_out(JObj) ->
    participant_volume_out(kz_json:to_proplist(JObj)).

-spec participant_volume_out_v(kz_term:api_terms()) -> boolean().
participant_volume_out_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop,
        ?PARTICIPANT_VOLUME_OUT_HEADERS,
        ?PARTICIPANT_VOLUME_OUT_VALUES,
        ?PARTICIPANT_VOLUME_OUT_TYPES
    );
participant_volume_out_v(JObj) ->
    participant_volume_out_v(kz_json:to_proplist(JObj)).
...
participant_event(Prop) when is_list(Prop) ->
    case participant_event_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?PARTICIPANT_EVENT_HEADERS, ?OPTIONAL_PARTICIPANT_EVENT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for participant_event response"}
    end;
participant_event(JObj) ->
    participant_event(kz_json:to_proplist(JObj)).

-spec participant_event_v(kz_term:api_terms()) -> boolean().
participant_event_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?PARTICIPANT_EVENT_HEADERS, ?PARTICIPANT_EVENT_VALUES, ?PARTICIPANT_EVENT_TYPES
    );
participant_event_v(JObj) ->
    participant_event_v(kz_json:to_proplist(JObj)).
...
event(Prop) when is_list(Prop) ->
    case event_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?CONFERENCE_EVENT_HEADERS, ?OPTIONAL_CONFERENCE_EVENT_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for conference event"}
    end;
event(JObj) ->
...
event_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?CONFERENCE_EVENT_HEADERS, ?CONFERENCE_EVENT_VALUES, ?CONFERENCE_EVENT_TYPES
    );
event_v(JObj) ->
...
conference_error(Prop) when is_list(Prop) ->
    case conference_error_v(Prop) of
        'true' ->
            kz_api:build_message(
                Prop, ?CONFERENCE_ERROR_HEADERS, ?OPTIONAL_CONFERENCE_ERROR_HEADERS
            );
        'false' ->
            {'error', "Proplist failed validation for conference error"}
    end;
conference_error(JObj) ->
    conference_error(kz_json:to_proplist(JObj)).

-spec conference_error_v(kz_term:api_terms()) -> boolean().
conference_error_v(Prop) when is_list(Prop) ->
    kz_api:validate(
        Prop, ?CONFERENCE_ERROR_HEADERS, ?CONFERENCE_ERROR_VALUES, ?CONFERENCE_ERROR_TYPES
    );
conference_error_v(JObj) ->
    conference_error_v(kz_json:to_proplist(JObj)).
...
config_req(JObj) ->
    config_req(kz_json:to_proplist(JObj)).
...
config_req_v(JObj) ->
    config_req_v(kz_json:to_proplist(JObj)).
...
config_resp(JObj) ->
    config_resp(kz_json:to_proplist(JObj)).
...
config_resp_v(JObj) ->
    config_resp_v(kz_json:to_proplist(JObj)).
...
dial_v(JObj) ->
    dial_v(kz_json:to_proplist(JObj)).
...
dial_resp(JObj) ->
    dial_resp(kz_json:to_proplist(JObj)).
...
dial_resp_v(JObj) ->
    dial_resp_v(kz_json:to_proplist(JObj)).
...
-spec publish_add_participant(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_add_participant(Zone, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?ADD_PARTICIPANT_VALUES, fun add_participant/1
    ),
...
-spec publish_deaf_participant(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_deaf_participant(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?DEAF_PARTICIPANT_VALUES, fun deaf_participant/1
    ),
...
-spec publish_participant_energy(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_participant_energy(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?PARTICIPANT_ENERGY_VALUES, fun participant_energy/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_participants_req(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_participants_req(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?PARTICIPANTS_REQ_VALUES, fun participants_req/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_participants_resp(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_participants_resp(Queue, Resp, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Resp, ?PARTICIPANTS_RESP_VALUES, fun participants_resp/1
    ),
    kz_amqp_util:targeted_publish(Queue, Payload, ContentType).
...
-spec publish_mute_participant(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_mute_participant(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?MUTE_PARTICIPANT_VALUES, fun mute_participant/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_relate_participants(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_relate_participants(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?RELATE_PARTICIPANTS_VALUES, fun relate_participants/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_undeaf_participant(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_undeaf_participant(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?UNDEAF_PARTICIPANT_VALUES, fun undeaf_participant/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_unmute_participant(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_unmute_participant(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?UNMUTE_PARTICIPANT_VALUES, fun unmute_participant/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_participant_volume_in(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_participant_volume_in(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?PARTICIPANT_VOLUME_IN_VALUES, fun participant_volume_in/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_participant_volume_out(kz_term:ne_binary(), kz_term:api_terms(), kz_term:ne_binary()) ->
    'ok'.
publish_participant_volume_out(ConferenceId, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?PARTICIPANT_VOLUME_OUT_VALUES, fun participant_volume_out/1
    ),
    kz_amqp_util:conference_publish(Payload, 'command', ConferenceId, [], ContentType).
...
-spec publish_participant_event(kz_term:ne_binary(), kz_term:ne_binary(), kz_term:api_terms()) ->
    'ok'.
...
-spec publish_participant_event(
...
publish_participant_event(ConferenceId, CallId, Event, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Event, ?PARTICIPANT_EVENT_VALUES, fun participant_event/1
    ),
    kz_amqp_util:conference_publish(
        Payload, 'event', ConferenceId, kz_amqp_util:encode(CallId), [], ContentType
    ).
...
event_binding_key(ConferenceId) when
...
publish_error(Queue, Req, ContentType) ->
    {'ok', Payload} = kz_api:prepare_api_payload(
        Req, ?CONFERENCE_ERROR_VALUES, fun conference_error/1
    ),
    kz_amqp_util:targeted_publish(Queue, Payload, ContentType).
...
publish_command(ConferenceId, Req, ContentType) ->
    ...
    case lists:keyfind(App, 1, ?APPLICTION_MAP) of
        'false' ->
            throw({'invalid_conference_command', Req});
        {_, Values, Fun} ->
