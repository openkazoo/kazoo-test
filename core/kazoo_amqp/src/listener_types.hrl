...
-type responder_callback_fun3() :: fun(
    (kz_json:object(), kz_term:proplist(), basic_deliver()) -> any()
).
-type responder_callback_fun4() :: fun(
    (kz_json:object(), kz_term:proplist(), basic_deliver(), amqp_basic()) -> any()
).
-type responder_callback_fun() ::
    responder_callback_fun2()
    | responder_callback_fun3()
    | responder_callback_fun4().

-type responder_callback() ::
    module()
    | {module(), atom()}
