...
start(_StartType, _StartArgs) ->
    ...
    kapps_maintenance:bind(
        {'refresh_account', <<"*">>},
        'kazoo_number_manager_maintenance',
        'update_number_services_view'
    ),
    kapps_maintenance:bind_and_register_views(
        ?APP, 'kazoo_number_manager_maintenance', 'register_views'
    ),
...
stop(_State) ->
    ...
    kapps_maintenance:unbind(
        {'refresh_account', <<"*">>},
        'kazoo_number_manager_maintenance',
        'update_number_services_view'
    ),
    kapps_maintenance:unbind(
        'register_views', 'kazoo_number_manager_maintenance', 'register_views'
    ),
    'ok'.
