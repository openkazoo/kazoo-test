...
-spec move_number_to_state
    (kn(), kz_term:ne_binary()) -> kn();
...
-spec move_phone_number_to_state(
    knm_phone_number:knm_phone_number(), kz_term:ne_binary(), kz_term:api_binary()
) ->
    knm_phone_number_return().
