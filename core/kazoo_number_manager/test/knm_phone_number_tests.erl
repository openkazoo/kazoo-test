...
is_dirty1_1_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_created">>, FixtureJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_modified">>, FixtureJObj),
...
is_dirty1_test_() ->
    ...
    [
        ?_assertEqual(
            kz_json:get_value(<<"_id">>, NewJObj),
            kz_json:get_value(<<"_id">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"_id">>, OldJObj),
            kz_json:get_value(<<"_id">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"_id">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_assigned_to">>, NewJObj),
            kz_json:get_value(<<"pvt_assigned_to">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_assigned_to">>, OldJObj),
            kz_json:get_value(<<"pvt_assigned_to">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_assigned_to">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_db_name">>, NewJObj),
            kz_json:get_value(<<"pvt_db_name">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_db_name">>, OldJObj),
            kz_json:get_value(<<"pvt_db_name">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_db_name">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_module_name">>, NewJObj),
            kz_json:get_value(<<"pvt_module_name">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_module_name">>, OldJObj),
            kz_json:get_value(<<"pvt_module_name">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_module_name">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_ported_in">>, NewJObj),
            kz_json:get_value(<<"pvt_ported_in">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_ported_in">>, OldJObj),
            kz_json:get_value(<<"pvt_ported_in">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_ported_in">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_reserve_history">>, NewJObj),
            kz_json:get_value(<<"pvt_reserve_history">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_reserve_history">>, OldJObj),
            kz_json:get_value(<<"pvt_reserve_history">>, JObj)
        ),
        ?_assertEqual([], knm_phone_number:reserve_history(PN)),

        ?_assertEqual(
            kz_json:get_value(<<"pvt_state">>, NewJObj),
            kz_json:get_value(<<"pvt_state">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_state">>, OldJObj),
            kz_json:get_value(<<"pvt_state">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_state">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_type">>, NewJObj),
            kz_json:get_value(<<"pvt_type">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_type">>, OldJObj),
            kz_json:get_value(<<"pvt_type">>, JObj)
        ),
        ...
        ?_assertEqual(
            kz_json:from_list([{<<"local">>, kz_json:new()}]),
        ...
        ?_assertNotEqual(
            ?KNM_DEFAULT_AUTH_BY, kz_json:get_value(<<"pvt_authorizing_account">>, OldJObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_authorizing_account">>, NewJObj),
...
is_dirty2_1_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_state">>, FixtureJObj),
            knm_phone_number:state(PN)
        ),
...
is_dirty2_test_() ->
    ...
    [
        ...
        ?_assertEqual(<<"in_service">>, kz_json:get_value(<<"pvt_state">>, NewJObj)),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_number_state">>, OldJObj),
            knm_phone_number:state(PN)
        ),
        ?_assertEqual(undefined, kz_json:get_value(<<"pvt_number_state">>, JObj)),
        ?_assertEqual(undefined, kz_json:get_value(<<"pvt_number_state">>, NewJObj)),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_created">>, OldJObj),
            knm_phone_number:created(PN)
        ),
        ...
        ?_assertEqual(
            true,
            kz_json:are_equal(
                kz_json:get_value(<<"pvt_features">>, OldJObj),
                knm_phone_number:features(PN)
            )
        ),
...
is_dirty3_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:to_map(kz_json:get_value(<<"pvt_features">>, OldJObj)),
...
is_dirty4_1_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:to_map(kz_json:get_value(<<"pvt_features">>, FixtureJObj)),
            kz_json:to_map(kz_json:get_value(<<"pvt_features">>, JObj))
        ),
        ?_assert(
            kz_json:are_equal(
                kz_json:get_value(<<"pvt_features">>, FixtureJObj),
                knm_phone_number:features(PN)
            )
        )
    ].
...
is_dirty4_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:to_map(kz_doc:public_fields(JObj)),
            kz_json:to_map(kz_doc:public_fields(NewJObj))
        ),
        ?_assertEqual(
            maps:remove(<<"e911">>, kz_json:to_map(kz_doc:public_fields(JObj))),
...
is_dirty6_test_() ->
    ...
    [
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_modified">>, OldJObj),
            kz_json:get_value(<<"pvt_modified">>, JObj)
        ),
        ?_assertEqual(
            kz_json:get_value(<<"pvt_modified">>, OldJObj),
        ...
        ?_assertEqual(
            kz_json:get_value(<<"pvt_used_by">>, OldJObj),
...
is_undefined_or_account_ids(undefined) ->
    true;
is_undefined_or_account_ids(V) when
    is_list(V)
->
    lists:all(fun is_account_id/1, V);
is_undefined_or_account_ids(_) ->
    false.
