...
move_changing_public_fields_test_() ->
    ...
    Options = [
        {public_fields, kz_json:from_list(Fields)}
    ...
    [
        ...
        {"verify a public key is set", ?_assertEqual(<<"my string">>, public_value(Key, N0))},
        {"verify that key got updated", ?_assertEqual(42, public_value(Key, N))},
        {"verify another key was added", ?_assertEqual(<<"bla">>, public_value(<<"a">>, N))},
