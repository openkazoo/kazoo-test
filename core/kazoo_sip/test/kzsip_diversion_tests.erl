...
from_binary_spaced_header_names_test_() ->
    Header =
        <<"<sip:+12345556543@192.168.47.68:5060>;privacy=off; reason=unconditional; counter=1">>,
    JObj = kzsip_diversion:from_binary(Header),
...
from_binary_extensions_test_() ->
    Header =
        <<"<sip:+12345556543@192.168.47.68:5060>;privacy=off;reason=unconditional;counter=1;some_extension;other_extension=foo">>,
